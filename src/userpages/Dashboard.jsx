...
const Dashboard = () => {
  ...
  const quickActions = [
    ...
    { icon: faUser, label: 'Edit Profile', path: '/user/profile', color: '#7c3aed' },
    { icon: faCalendarAlt, label: 'About Us', path: '/userabout', color: '#ea580c' }
  ];
                  ...
                  <div style={{
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                      ...
                      <div style={{ display: 'flex' }}>
                        ...
                        <span style={{ fontSize: '1.1rem', color: '#87CEEB', fontWeight: '600', marginLeft: '10px' }}>{user.bloodType || user.blood_type || 'N/A'}</span>
                      </div>
                      <div style={{ display: 'flex' }}>
                      ...
                      <div style={{ display: 'flex' }}>
                        <span style={{ fontSize: '1.1rem', color: '#87CEEB', fontWeight: '600', minWidth: '120px' }}>Address:</span>
                        <span style={{ fontSize: '1.1rem', color: '#87CEEB', fontWeight: '600', marginLeft: '10px' }}>{user.address || 'N/A'}</span>
                      </div>
                      {user.aadhar && (
                        <div style={{ display: 'flex' }}>
                          <span style={{ fontSize: '1.1rem', color: '#87CEEB', fontWeight: '600', minWidth: '120px' }}>Aadhar:</span>
                          <span style={{ fontSize: '1.1rem', color: '#87CEEB', fontWeight: '600', marginLeft: '10px' }}>{user.aadhar}</span>
                        </div>
                      )}
                      {user.created_at && (
                        <div style={{ display: 'flex' }}>
                          <span style={{ fontSize: '1.1rem', color: '#87CEEB', fontWeight: '600', minWidth: '120px' }}>Member Since:</span>
                          <span style={{ fontSize: '1.1rem', color: '#87CEEB', fontWeight: '600', marginLeft: '10px' }}>{new Date(user.created_at).toLocaleDateString()}</span>
                        </div>
                      )}
                    </div>
